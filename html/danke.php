...
$felderleer = "<small>Fehler<br>Die Nachricht konnte nicht versandt werden, da nicht alle Felder ausgef&uuml;llt wurden.<br><br>Error<br>The message wasn't sent because you didn't fill in all fields.</small>";

/*Wie soll der Text aussehen, wenn die E-Mail versendet wurde?*/
$abgesandt = "<small>Danke,<br>die Nachricht wurde versandt und ich werde mich evtl. noch einmal melden.<br><br>Thanks,<br>the message has been sent and maybe I will contact you.</small>";
